...
class   AppColors {
  ...
  static const Color themeColor = Color.fromARGB(255,176, 2, 2);
  static final Color mainColor = Color.fromARGB(169, 46, 38, 196);
  ...
  static const Color buttonBackgroundColor = Color.fromARGB(255, 53, 98, 181);
